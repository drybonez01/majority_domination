...
def majority_influence_diffusion(graph, initial_states, seed_set):
...
def main():
    ...
    influenced_nodes, total_influenced = majority_influence_diffusion(G, initial_states, seed_set)
